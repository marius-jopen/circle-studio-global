...
async function importPeopleWithTimestamps() {
  console.log('🚀 Starting people import with unique timestamps...');
  ...
  try {
    ...
    // Test with first 5 people only
    const testData = peopleData.slice(0, 5);
...
importPeopleWithTimestamps().catch(console.error);
