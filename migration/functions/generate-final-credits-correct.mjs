...
async function generateFinalCreditsCorrect() {
  console.log('🎯 Correct Credits Generation for "The Final" Project');
  console.log('====================================================\n');
  ...
  try {
    ...
    // Create people lookup by TITLE field (correct structure)
    ...
    console.log('\n📋 CORRECT CREDITS STRUCTURE FOR PRISMIC:');
    console.log('=========================================');
    ...
    const exportPath = join(__dirname, '../output/final-project-credits-correct.json');
    writeFileSync(exportPath, JSON.stringify(exportData, null, 2));
    console.log(`💾 Complete data saved to: ${exportPath}`);

    console.log('🎉 CORRECT CREDITS GENERATION COMPLETED!');
    console.log('=======================================');
...
generateFinalCreditsCorrect().catch(console.error);
