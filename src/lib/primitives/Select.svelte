...
<div class="flex flex-col gap-1 w-full">
  {#if label}
    <div class="flex justify-between items-center">
      <label for="select-{Math.random()}" class="font-medium text-gray-700 text-sm">
        {label}
  ...
  <div class="relative inline-block w-full">
    ...
    <div class="absolute top-1/2 right-2 -translate-y-1/2 pointer-events-none text-gray-600 transition-transform duration-200">
