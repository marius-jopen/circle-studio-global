...
>
	...
	<div class="flex justify-center items-center w-full pt-8">
		<input
			...
			class="px-6 pt-3.5 text-neutral-500 hover:text-black transition-colors duration-300 pb-4 bg-neutral-100 rounded-3xl w-full max-w-xl text-3xl outline-none focus:outline-none focus:ring-0 focus:border-black"
		/>
	</div>
</section>
